...
<div class="wrapper">
    ...
    <section class="pin pin-1">
       <div class="p1-inner">
           ...
           <div class="btn-open fade">
               <img src="/app/images/p1-3.png" alt=""/>
           </div>
           <div class="p1-t1 fade animate delay1">
    ...
    <section class="pin pin-2">
        ...
        <form action="" class="form-validate">
            ...
            <div class="input-box input-box-keycode">
                <input type="tel" class="input-keycode" id="input-keycode" placeholder="输入验证码"/>
                <div class="btn-getkeycode"></div>
            </div>
