$(function(){
    ...
    $('.show-terms').on('touchstart', function(){
        var popContent = '<h3 class="title">条款及条件</h3><div class="popcontent"><p>1.	1.	本次活动自2016年11月16日起，限前1000名新关注者领取活动赠品，数量有限，赠完为止。 </p><p>2.本次活动只限中国大陆地区参与，敬请谅解。</p><p>3.在符合法律相关规定的情况下，您必须同意活动主办方获得您的姓名，头像与个人信息，主办方并不需要为此再支付额外费用。</p><p>4.包裹会在个人信息确认后4-7天工作日发出。</p></div>';
